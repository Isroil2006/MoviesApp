...
let emailError = document.getElementById("regEmailError") as HTMLDivElement | null;
let passwordError = document.getElementById("regPasswordError") as HTMLDivElement | null;
...
if (passwordInput && passwordError) {
  passwordInput.addEventListener("input", () => {
    if (!passwordInput.value) {
      ...
      passwordError.textContent = "Parol kamida 8 ta belgidan iborat, kamida 1 ta harf va 1 ta raqam bo'lishi kerak!";
    } else {
      passwordError.textContent = "";
    }
  });
...
// Modal elementlar
const autoPasswordModal = document.getElementById("autoPasswordModal") as HTMLElement | null;
const acceptAutoPassword = document.getElementById("acceptAutoPassword") as HTMLButtonElement | null;
const declineAutoPassword = document.getElementById("declineAutoPassword") as HTMLButtonElement | null;
...
=======
// Parolga avtomatik qiymat berish
if (passwordInput) {
  passwordInput.addEventListener("focus", () => {
    if (!passwordInput.value) {
      autoGeneratedPassword = generatePassword(10);
...
>>>>>>> c6163f1d8945b3880a6befce30b6aa4e86864599
}
